...
def denoise(
    ...
    for prev_timestep in tqdm(timestep_schedule): # "previous" as in higher than the current snr
        noise_prediction = noise_prediction_model.predict_noise(latent, current_timestep)
